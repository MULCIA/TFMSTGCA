...
de las que se comentan. El programa cuenta con un único punto de entrada~\ref{fig:arch}, en este caso, siguiendo el patrón
...
En este caso, el programa cuenta con 6 módulos~\ref{fig:arch}. El módulo principal, \textit{automata.py}, presenta
