...
tiende a ocupar el exterior y, en este caso, también una pequeña parte del espacio
...
El resultado obtenido aquí es diferente a priori. El número de células cancerosas
...
como ocurre en el experimento de los autores. Seguido de $SG$ y $EA$ respectivamente. Un detalle
...
Desde el punto de vista de los marcadores, como se muestra en la figura~\ref{fig:ownexp5-2}, es muy
...
Desde el punto de vista de los marcadores, como se muestra en la figura~\ref{fig:ownexp6-2}, es muy
parecido. Como ambos comportamientos son similares a los obtenidos por los autores se entiende
que la explicación es la misma que se presenta en el capítulo anterior donde
se presentan los resultados de los autores.
...
\caption{Efecto de la eliminación de un marcador con parámetros por defecto excepto con $m = 100$.}
\label{fig:ownexp7-1}
\end{figure}
